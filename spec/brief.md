...
Fill every field. Do not leave placeholders. If a field cannot be filled,
explain why — do not omit it.
...
- [ ] `journalistic_angle` section contains no dataset names, provider names, or method names
